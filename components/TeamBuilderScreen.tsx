...
// FIX: Changed STAT_NAMES to STAT_NAME_KEYS to match exports from types.ts
...
// FIX: Added useTranslation hook for internationalization.
...
const TeamBuilderScreen: React.FC<TeamBuilderScreenProps> = ({ initialPlayers, onReset, selectedClass }) => {
    ...
    const sortingControls = (
        <div className="flex items-center gap-2 text-sm">
            {/* FIX: Use translation for hardcoded string. */}
            ...
            >
                ...
                {/* FIX: Use STAT_NAME_KEYS and translation for stat names. */}
                {STAT_KEYS.map(key => (
